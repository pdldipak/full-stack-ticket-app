...
Full-stack ticketing for **NRNA NCC Sweden** — *New Year Eve 2083 BS · Melina Rai*. **Stockholm:** 11 April 2026, 16:00–20:00, Åstra Folkets Hus. **Gothenburg:** 12 April 2026, 16:00–20:00 (venue TBA on app until confirmed). Stack: **React (Vite) + Tailwind**, **Express**, **MySQL**. Event copy lives in `frontend/src/config/eventConfig.js` (single file to edit for another event).
